function [H_e,M_sq,D] = esmV(rho,c,k,r_ms,r_lh,r_i)
% Equivalent source method in vectorized implementation.
%
...
% reference. Implementation is vectorized in arrays multiplications.
%
% Reference: 
